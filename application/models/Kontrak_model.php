...
a.JAM_PERMINGGU, c.ID_PEKERJAAN, b.PEKERJAAN, a.TGL_PEMBERIAN_GAJI, a.JUMLAH_GAPOK, FORMAT(a.JUMLAH_GAPOK, 0) as JUMLAH_GAPOKF, a.TUNJANGAN_KESEHATAN, FORMAT(a.TUNJANGAN_KESEHATAN, 0) as TUNJANGAN_KESEHATANF, a.TUNJANGAN_TRANSPORTASI, FORMAT(a.TUNJANGAN_TRANSPORTASI, 0) as TUNJANGAN_TRANSPORTASIF, a.UANG_KERAJINAN, FORMAT(a.UANG_KERAJINAN, 0) as UANG_KERAJINANF,
...
i.JAM_PERMINGGU as 'JAM_PERMINGGU2' FROM TB_KONTRAK a LEFT JOIN JUSTIFIKASI_PEKERJAAN c 
ON a.ID = c.ID_KONTRAK LEFT JOIN TB_PEKERJAAN b ON c.ID_PEKERJAAN = b.ID LEFT JOIN MST_TKI e ON c.ID_TKI = e.ID LEFT JOIN TB_GROUP g ON e.ID_GROUP = 
