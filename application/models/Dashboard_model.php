...
class Dashboard_model extends CI_Model {
	...
	public function get_data_dashboard($param, $value = FALSE){
		if ($param == 'UNAPPROVECTKI') {
			$query = "SELECT a.ID, a.NAMA, c.NAMA_PERUSAHAAN FROM MST_TKI a JOIN MST_GROUP b ON a.ID_GROUP = b.ID JOIN MST_PERUSAHAAN c ON b.ID_PERUSAHAAN = c.ID WHERE a.APPROVE = '0' ORDER BY a.UPDATE_DATE DESC";
		} elseif ($param == 'NOTCREATEDPERJANJIAN') {
			$query = "SELECT a.ID as 'ID_JUSTIFIKASI', c.ID as 'ID_TKI', b.PEKERJAAN as 'PEKERJAAN', c.NAMA as 'NAMA_TKI', CONCAT(d.NAMA, ' | ', e.NAMA_PERUSAHAAN) as 'PENYALUR' FROM JUSTIFIKASI_PEKERJAAN a JOIN MST_PEKERJAAN b ON a.ID_PEKERJAAN = b.ID JOIN MST_TKI c ON a.ID_TKI = c.ID JOIN MST_USER d ON a.CREATED_BY = d.ID JOIN MST_GROUP f ON c.ID_GROUP = f.ID JOIN MST_PERUSAHAAN e ON f.ID_PERUSAHAAN = e.ID WHERE (a.STATUS = '1' AND a.DATA_DIRI_APPROVAL = '1' AND a.APPROVED_BY_1 IS NOT NULL AND ID_LOWONGAN IS NOT NULL AND (a.SURAT_PERJANJIAN_APPROVAL IS NULL OR a.SURAT_PERJANJIAN_APPROVAL = '0')) ORDER BY a.UPDATE_DATE DESC";
			...
			$query = "SELECT a.ID, a.NAMA, a.CATATAN, b.NAMA as 'NAMA_USER' FROM MST_TKI a JOIN MST_USER b ON a.APPROVED_BY = b.ID WHERE a.APPROVE = '2' AND a.ID_GROUP = '".$_SESSION['logged_in']['group']."'";
		} elseif ($param == 'UNAPPROVEPENYALUR') {
			$query = "SELECT a.ID, a.NAMA, c.NAMA_PERUSAHAAN FROM MST_PENYALUR a JOIN MST_GROUP b ON a.ID_GROUP = b.ID JOIN MST_PERUSAHAAN c ON b.ID_PERUSAHAAN = c.ID WHERE a.APPROVE = '0' ORDER BY a.UPDATE_DATE DESC";
		} elseif ($param == 'REJECTEDPENYALUR') {
			$query = "SELECT a.ID, a.NAMA, c.NAMA_PERUSAHAAN, a.CATATAN FROM MST_PENYALUR a JOIN MST_GROUP b ON a.ID_GROUP = b.ID JOIN MST_PERUSAHAAN c ON b.ID_PERUSAHAAN = c.ID WHERE a.APPROVE = '2' ORDER BY a.UPDATE_DATE DESC";
		} elseif ($param == 'UNAPPROVEPERJANJIANTAB') {
			$query = "SELECT a.ID as 'ID_JUSTIFIKASI', c.ID as 'ID_TKI', b.PEKERJAAN as 'PEKERJAAN', c.NAMA as 'NAMA_TKI', CONCAT(d.NAMA, ' | ', e.NAMA_PERUSAHAAN) as 'PENYALUR' FROM JUSTIFIKASI_PEKERJAAN a JOIN MST_PEKERJAAN b ON a.ID_PEKERJAAN = b.ID JOIN MST_TKI c ON a.ID_TKI = c.ID JOIN MST_USER d ON a.CREATED_BY = d.ID JOIN MST_GROUP f ON c.ID_GROUP = f.ID JOIN MST_PERUSAHAAN e ON f.ID_PERUSAHAAN = e.ID WHERE (a.STATUS = '1' AND a.DATA_DIRI_APPROVAL = '1' AND a.APPROVED_BY_1 IS NOT NULL AND ID_LOWONGAN IS NOT NULL AND a.SURAT_PERJANJIAN_APPROVAL = '3') ORDER BY a.UPDATE_DATE DESC";
		} elseif ($param == 'REJECTEDPERJANJIANTAB') {
			$query = "SELECT a.ID as 'ID_JUSTIFIKASI', c.ID as 'ID_TKI', b.PEKERJAAN as 'PEKERJAAN', c.NAMA as 'NAMA_TKI', CONCAT(d.NAMA, ' | ', e.NAMA_PERUSAHAAN) as 'PENYALUR', g.CATATAN FROM JUSTIFIKASI_PEKERJAAN a JOIN MST_PEKERJAAN b ON a.ID_PEKERJAAN = b.ID JOIN MST_TKI c ON a.ID_TKI = c.ID JOIN MST_USER d ON a.CREATED_BY = d.ID JOIN MST_GROUP f ON c.ID_GROUP = f.ID JOIN MST_PERUSAHAAN e ON f.ID_PERUSAHAAN = e.ID JOIN MST_SURAT_PERJANJIAN g ON a.ID_PERJANJIAN = g.ID WHERE (a.STATUS = '1' AND a.DATA_DIRI_APPROVAL = '1' AND a.APPROVED_BY_1 IS NOT NULL AND ID_LOWONGAN IS NOT NULL AND a.SURAT_PERJANJIAN_APPROVAL = '2') ORDER BY a.UPDATE_DATE DESC";
		} elseif ($param == 'NOTCREATEDKONTRAK') {
			$query = "SELECT a.ID as 'ID_JUSTIFIKASI', c.ID as 'ID_TKI', b.PEKERJAAN as 'PEKERJAAN', c.NAMA as 'NAMA_TKI', CONCAT(d.NAMA, ' | ', e.NAMA_PERUSAHAAN) as 'PENYALUR', g.CATATAN FROM JUSTIFIKASI_PEKERJAAN a JOIN MST_PEKERJAAN b ON a.ID_PEKERJAAN = b.ID JOIN MST_TKI c ON a.ID_TKI = c.ID JOIN MST_USER d ON a.CREATED_BY = d.ID JOIN MST_GROUP f ON c.ID_GROUP = f.ID JOIN MST_PERUSAHAAN e ON f.ID_PERUSAHAAN = e.ID JOIN MST_KONTRAK g ON a.ID_KONTRAK = g.ID WHERE (a.STATUS = '1' AND a.DATA_DIRI_APPROVAL = '1' AND a.APPROVED_BY_1 IS NOT NULL AND ID_LOWONGAN IS NOT NULL AND (a.KONTRAK_KERJA_APPROVAL IS NULL OR a.KONTRAK_KERJA_APPROVAL = '0')) ORDER BY a.UPDATE_DATE DESC";
		} elseif ($param == 'REJECTEDKONTRAK') {
			$query = "SELECT a.ID as 'ID_JUSTIFIKASI', c.ID as 'ID_TKI', b.PEKERJAAN as 'PEKERJAAN', (SELECT NAMA FROM MST_USER WHERE ID = a.APPROVED_BY_3) as 'APPROVED_BY', c.NAMA as 'NAMA_TKI', CONCAT(d.NAMA, ' | ', e.NAMA_PERUSAHAAN) as 'PENYALUR', g.CATATAN FROM JUSTIFIKASI_PEKERJAAN a JOIN MST_PEKERJAAN b ON a.ID_PEKERJAAN = b.ID JOIN MST_TKI c ON a.ID_TKI = c.ID JOIN MST_USER d ON a.CREATED_BY = d.ID JOIN MST_GROUP f ON c.ID_GROUP = f.ID JOIN MST_PERUSAHAAN e ON f.ID_PERUSAHAAN = e.ID JOIN MST_KONTRAK g ON a.ID_KONTRAK = g.ID WHERE (a.STATUS = '1' AND a.DATA_DIRI_APPROVAL = '1' AND a.APPROVED_BY_1 IS NOT NULL AND ID_LOWONGAN IS NOT NULL AND a.KONTRAK_KERJA_APPROVAL = '2') ORDER BY a.UPDATE_DATE DESC";
		} elseif ($param == 'NOTCREATEDPEKERJAAN') {
			$query = "SELECT a.ID as 'ID_JUSTIFIKASI', c.ID as 'ID_TKI', b.PEKERJAAN as 'PEKERJAAN', c.NAMA as 'NAMA_TKI', CONCAT(d.NAMA, ' | ', e.NAMA_PERUSAHAAN) as 'PENYALUR'FROM JUSTIFIKASI_PEKERJAAN a JOIN MST_PEKERJAAN b ON a.ID_PEKERJAAN = b.ID JOIN MST_TKI c ON a.ID_TKI = c.ID JOIN MST_USER d ON a.CREATED_BY = d.ID JOIN MST_GROUP f ON c.ID_GROUP = f.ID JOIN MST_PERUSAHAAN e ON f.ID_PERUSAHAAN = e.ID WHERE (a.STATUS = '1' AND a.DATA_DIRI_APPROVAL = '1' AND a.APPROVED_BY_1 IS NOT NULL AND ID_LOWONGAN IS NULL) ORDER BY a.UPDATE_DATE DESC";
		} elseif ($param == 'APPROVEPERJANJIAN') {
			$query = "SELECT a.ID as 'ID_JUSTIFIKASI', c.ID as 'ID_TKI', b.PEKERJAAN as 'PEKERJAAN', (SELECT NAMA FROM MST_USER WHERE ID = a.APPROVED_BY_3) as 'APPROVED_BY', c.NAMA as 'NAMA_TKI', (SELECT NAMA FROM MST_USER WHERE ID = g.CREATED_BY) as 'CREATED_BY' FROM JUSTIFIKASI_PEKERJAAN a JOIN MST_PEKERJAAN b ON a.ID_PEKERJAAN = b.ID JOIN MST_TKI c ON a.ID_TKI = c.ID JOIN MST_USER d ON a.CREATED_BY = d.ID JOIN MST_GROUP f ON c.ID_GROUP = f.ID JOIN MST_PERUSAHAAN e ON f.ID_PERUSAHAAN = e.ID JOIN MST_SURAT_PERJANJIAN g ON a.ID_PERJANJIAN = g.ID WHERE (a.STATUS = '1' AND a.DATA_DIRI_APPROVAL = '1' AND a.APPROVED_BY_1 IS NOT NULL AND ID_LOWONGAN IS NOT NULL AND a.SURAT_PERJANJIAN_APPROVAL = '3' AND c.ID_GROUP = '".$_SESSION['logged_in']['group']."') ORDER BY a.UPDATE_DATE DESC";
		} elseif ($param == 'APPROVEKONTRAK') {
			$query = "SELECT a.ID as 'ID_JUSTIFIKASI', c.ID as 'ID_TKI', b.PEKERJAAN as 'PEKERJAAN', (SELECT NAMA FROM MST_USER WHERE ID = a.APPROVED_BY_3) as 'APPROVED_BY', c.NAMA as 'NAMA_TKI', (SELECT NAMA FROM MST_USER WHERE ID = g.CREATED_BY) as 'CREATED_BY' FROM JUSTIFIKASI_PEKERJAAN a JOIN MST_PEKERJAAN b ON a.ID_PEKERJAAN = b.ID JOIN MST_TKI c ON a.ID_TKI = c.ID JOIN MST_USER d ON a.CREATED_BY = d.ID JOIN MST_GROUP f ON c.ID_GROUP = f.ID JOIN MST_PERUSAHAAN e ON f.ID_PERUSAHAAN = e.ID JOIN MST_KONTRAK g ON a.ID_KONTRAK = g.ID WHERE (a.STATUS = '1' AND a.DATA_DIRI_APPROVAL = '1' AND a.APPROVED_BY_1 IS NOT NULL AND ID_LOWONGAN IS NOT NULL AND a.KONTRAK_KERJA_APPROVAL = '3' AND c.ID_GROUP = '".$_SESSION['logged_in']['group']."') ORDER BY a.UPDATE_DATE DESC";
		} elseif ($param == 'AUDIT') {
			$query = "SELECT b.JENIS, (SELECT NAMA FROM MST_USER WHERE ID = a.ID_USER) as 'USER', SUBSTRING(a.CATATAN, 1,80) as 'CATATAN', a.INSERT_DATE FROM LOG a JOIN TB_RULE_ACT b ON a.JENIS = b.ID WHERE a.STATUS = '1' ORDER BY a.INSERT_DATE DESC LIMIT 100";
		} elseif ($param == 'AUDITPARAM') {
			$query = "SELECT b.JENIS, (SELECT NAMA FROM MST_USER WHERE ID = a.ID_USER) as 'USER', SUBSTRING(a.CATATAN, 1,80) as 'CATATAN', a.INSERT_DATE FROM LOG a JOIN TB_RULE_ACT b ON a.JENIS = b.ID WHERE a.ID_USER = '".$value."' ORDER BY a.INSERT_DATE DESC";
		} else {
