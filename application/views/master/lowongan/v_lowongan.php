        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><a href="<?php echo base_url('index.php/master/Lowongan');?>">Master Lowongan</a></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="non_export" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php foreach($data_lowongan->result() as $row ): ?>
                      <tr>
          ...
          <div class="col-md-12">
            ...
            <div class="card">
              ...
              <div class="card-body p-0">
                <table id="non_export2" class="table table-sm">
                  <thead>
                    <tr>
                      <th>Kegiatan</th>
                      <th>SET</th>
