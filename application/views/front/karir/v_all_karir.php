            ...
            <div class="row">
                <div class="col-lg-8 mb-5 mb-lg-0">
                    <div class="blog_left_sidebar">
                        <?php foreach($karir->result() as $row ): ?>
                        <article class="blog_item">
                            ...
                            <div class="blog_details">
                                <a class="d-inline-block" href="<?php echo base_url('index.php/Front/karir/detail/').$row->ID;?>">
                ...
                <div class="col-lg-4">
                    <div class="blog_right_sidebar">
                        <aside class="single_sidebar_widget popular_post_widget">
                            ...
                            <?php foreach($sum_karir->result() as $row ): ?>
                            <div class="media post_item">
                                <div class="media-body">
                                    <a href="<?php echo base_url('index.php/Front/karir/detail/').$row->ID;?>">
