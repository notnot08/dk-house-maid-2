  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Cari Kontrak Kerja</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?php echo base_url();?>">Dashboard</a></li>
              <li class="breadcrumb-item"><a href="#">Kontrak</a></li>
              <li class="breadcrumb-item active">Cari Kontrak Kerja</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              <!-- form start -->
              <div class="card-body">
                <form action="<?php echo base_url('index.php/Kontrak/cari/search');?>" method="post">
                  <div class="row">
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <select class="form-control" name="param">
                          ...
                          <option value="PIHAK1">PIHAK PERTAMA</option>
                        </select>
                      </div>
                    </div>
                    <div class="col-sm-6">
                    ...
                    <div class="col-md-12">
                      <button type="submit" class="btn btn-primary btn-block">CARI KONTRAK KERJA</button>
                    </div>
                  </div>
                </form>
              </div>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <div class="dropdown-menu" role="menu">
                          <a class="dropdown-item" href="<?php echo base_url('index.php/Kontrak/detail/').$row->ID;?>">Lihat</a>
